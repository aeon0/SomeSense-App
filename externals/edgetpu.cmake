...
if (BUILD_ARM)
  SET(CMAKE_INSTALL_RPATH "${EXTERNAL_INSTALL_DIR}/edgetpu/libedgetpu/throttled/aarch64")
  SET(EDGE_TPU_LIBS ${EXTERNAL_INSTALL_DIR}/edgetpu/libedgetpu/throttled/aarch64/libedgetpu.so.1)
else()
